  ...
  return (
    ...
    <div className="container px-4 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex items-center w-full md:w-4/6">
        <form onSubmit={getQueriedVideos} className="flex items-center w-full">
          <input
            type="text"
          ...
          />
          <button
            className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-r-lg transition duration-200"
          >
            Search
          </button>
        </form>
